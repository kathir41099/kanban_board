...
export default {
    ...
    return {
      userName: {
        required: requiredIf(function () {
          console.log('tast tyow header', this.taskTypeHeader, this.userName, this.taskName)
  ...
  methods: {
    ...
    async createNewTask() {
      console.log('submitForm', await this.submitForm())
      ...
      if (await this.submitForm()) {
        ...
        this.todoLists[index].list.push({
